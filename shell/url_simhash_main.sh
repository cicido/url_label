...
class="com.meizu.algo.browser.UrlSimHash"
mysubmit(){
    echo "$@"
    submit_files=""
    num_executors=$1
...
stat_date=$1
mysubmit 20 seg false ${stat_date}

mysubmit 20 hash false ${stat_date}

mysubmit 50 same false ${stat_date}

mysubmit 50 kbits false ${stat_date}

mysubmit 50 savedup false ${stat_date}
